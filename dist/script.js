...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionForElems(event, elem, prop) {
  ...
  ;
  bindActionForElems('click', windowForm, 'form');
  bindActionForElems('input', windowHeight, 'height');
  bindActionForElems('input', windowWidth, 'width');
  bindActionForElems('change', windowType, 'type');
  bindActionForElems('change', windowProfile, 'profile');
};
